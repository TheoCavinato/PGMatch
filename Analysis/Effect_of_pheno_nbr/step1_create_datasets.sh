...
for ITR in {1..100}; do
	...
	#awk -F '\t' 'NR>1{ if($1 != 30180 && $1!=21001) {print}}' $VAR_EXPL_NO_CORR | head -n $NBR_PHENO > $USED_PHENO  # remove lymphocyte percentage (because we already have lymphocyte count)
