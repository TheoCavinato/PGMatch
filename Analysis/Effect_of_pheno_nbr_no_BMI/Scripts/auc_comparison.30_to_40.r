...
# debugging
#args$concat_data = "/data/FAC/FBM/DBC/zkutalik/default_sensitive/tcavinat/Phenotype_inference_attack/Plot_data/Effect_of_pheno_nbr_no_BMI/concat_all_phenos.tsv"
#args$out_auc_table = "/data/FAC/FBM/DBC/zkutalik/default_sensitive/tcavinat/Phenotype_inference_attack/Plot_data/Effect_of_pheno_nbr_no_BMI/auc_table.30_to_40.tsv"
#args$out_pdf = "/scratch/tcavinat/Phenotype_inference_attack/Effect_of_pheno_nbr_no_BMI//Plots/test.pdf"
...
p_final = ggarrange(p_sup, p_unsup, ncol=2, nrow=1,labels=c("A","B"))
title <- grid::textGrob("Identifying Matches and Mimsatches",
                        gp = grid::gpar(fontsize = 14, fontface = "bold"))

ggsave(args$out_pdf, height=5, width=10)
