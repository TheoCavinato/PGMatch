...
# calssic unsupervised
Rscript $PHENO_VS_PGS/moments_unsupervised.r --r2 $R2 --ce $CE --cg $CG --moments $MOMENTS_UNSUP_R2_CE_CG
# classic unsupervise x genetic correlation from LDSC
Rscript $PHENO_VS_PGS/moments_unsupervised.r --r2 $R2 --ce $CE --cg $LDSC_CG --moments $MOMENTS_UNSUP_R2_CE_LDSC_CG
# unsupervised using LDSC CG even for CE
Rscript $PHENO_VS_PGS/moments_unsupervised.r --r2 $R2 --ce $LDSC_CG --cg $LDSC_CG --moments $MOMENTS_UNSUP_R2_LDSC_CG_LDSC_CG
