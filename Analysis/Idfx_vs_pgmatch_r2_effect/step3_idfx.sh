...
#SBATCH --output /scratch/tcavinat/Phenotype_inference_attack/Idfx_vs_me_r2_effect/logs/%x_%A-%a.out
#SBATCH --error  /scratch/tcavinat/Phenotype_inference_attack/Idfx_vs_me_r2_effect/logs/%x_%A-%a.err
