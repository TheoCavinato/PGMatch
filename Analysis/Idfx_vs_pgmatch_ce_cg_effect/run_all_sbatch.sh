...
#SBATCH --output /scratch/tcavinat/Phenotype_inference_attack/Idfx_vs_pgmatch_ce_cg_effect/logs/%x_%A-%a.out
#SBATCH --error  /scratch/tcavinat/Phenotype_inference_attack/Idfx_vs_pgmatch_ce_cg_effect/logs/%x_%A-%a.err
