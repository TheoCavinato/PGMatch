...
#	--pgs_test_p $PGS_test_h0 \
#	--pgs_train_p $PGS_train \
...
#for FILE in  $PGS_idfx_train $PHENO_idfx_train; do
#	zcat $FILE | wc -l
#done
#
#echo "Next numbers should be the same:"
#for FILE in $PHENO_idfx_test $PGS_idfx_test; do
#	zcat $FILE | wc -l
#done
#
## prepare mapping
...
##------------------------------------------------------------------------------#
#
#training_ids_h1=$(zcat $PGS_train | awk 'NR>1{if(NR!=2) printf ","; printf $1}')
...
#
#testing_ids_h1=$(zcat $PGS_test | awk 'NR>1{if(NR!=2) printf ","; printf $1}')
